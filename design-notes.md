...
6. **The Vortec Advantage** — the live Safety / Durability / Productivity / Support pillars as scannable cards.
7. **About + stats** — condensed Vortec story with the real "revegetate & control erosion effectively" mission line.
8. **Testimonials** — credibility cards (placeholder contractor quotes — swap for real reviews before launch).
9. **Lead band — phone-first** — leads with the phone number, backed by a short 4-field quote form (vs. the live 16-field form).
10. **Resources** — the live hydroseeding guides reframed as buyer resources.
